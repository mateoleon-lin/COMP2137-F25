...
#Gathering vendor make and model of disk
...
#For process count I will create the command to retrieve all the info in one line but I will create another variable to add a>
